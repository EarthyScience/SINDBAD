...
# Description
The `SindbadCore.Models` module provides the infrastructure for defining and implementing terrestrial ecosystem models within the SINDBAD framework. It includes tools for model definition, parameter management, and method implementation.
...
module Models
    ...
    using ..SindbadCore
    import ..SindbadCore.Types: purpose, LandEcosystem
    ...
    function getModelDocString()
        ...
        if length(stack) > 1
            ...
            c_type = getproperty(SindbadCore.Models, Symbol(c_name))
