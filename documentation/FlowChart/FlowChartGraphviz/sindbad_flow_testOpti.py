...
grph.node_attr.update(shape='record',color='#cccccc',fillcolor='#dddddd', style='rounded,filled')
...
f=file('callGraphSB_testOpti.JSON')
node_list=[]
node_dic={}
nprev=''
...
#set_node_atr(['nc_varget'],colo='#ff9988')
#n=grph.get_node(node_dic_full['tem'])
grph.graph_attr.update(overlap='false')
grph.graph_attr.update(fontsize='14')

grph.write("sindbad_testOpti.dot") # write to simple.dot

grph.draw('sindbad_testOpti.pdf',prog="dot") # draw to png using circo
