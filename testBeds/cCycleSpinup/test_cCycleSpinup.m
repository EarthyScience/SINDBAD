...
%             diary([oufile '.log'])
            ...
            %
            test_outDirPath=[info.experiment.outputDirPath 'testOutputs/cCycleSpinup/'];
            ...
            if saveLongStates
                ...
                save_gcf(gcf,[test_outDirPath 'run_cCycle_debug_simpleVScasa_' strExtra num2str(NI2E) '_4_TS_' cCycleModel{:} '_' strN2],1,1)
            %%
            end
...
%             diary('off')
    ...
    for cCycleModel = cCycleModelVec
        ...
        save_gcf(gcf,[test_outDirPath 'run_cCycle_debug_simpleVScasa_' strExtra num2str(NI2E) '_4_compSpinUp_' cCycleModel{:}],1,1)
    end
    %%
    if compareModels
        for i = [1 2 3]
            ...
            save_gcf(gcf,[test_outDirPath 'run_cCycle_debug_simpleVScasa_'  strExtra num2str(NI2E) '_4_compModels_' strN2],1,1)
        end
    end
end