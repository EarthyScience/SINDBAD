...
%
% Test 1:   deflate on netcdf-3 file
% Test 2:   deflate on netcdf-3 64bit offset file
% Test 3:   shuffle off, deflate off, netcdf-4
% Test 4:   shuffle off, deflate on, netcdf-4
...
test_netcdf4_1d_shuffle_off_deflate_off(ncfile); % #3 
test_netcdf4_1d_shuffle_off_deflate_on(ncfile); % #3 
test_netcdf4_1d_shuffle_on_deflate_off(ncfile); % #3 
test_netcdf4_1d_shuffle_on_deflate_on(ncfile); % #3 
