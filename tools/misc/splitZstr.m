function splittedstring = splitZstr(inpstr,delimiter)
%FUNCTION splitZstr
%
%-USE:
%
...
%
%-SYNTAX
%output = splitZstr(inpstr[,delimiter])
%
%inpstr:    string containing delimiter separatede text , eg
%           fasiudfh,48869,dsa,34.67
%delimiter: optional, if omitted the delimiter is , (comma)
%
%-OUTPUT
%
%An x by 1 cell matrix containing the splitted values
%
%-INFO
%
...
if ~strmatch(version,'7.2.0.232 (R2006a)')
    splittedstring = strsplit(cvar,'.');
    return
end
