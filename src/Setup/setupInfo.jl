...
function setModelRunInfo(info::NamedTuple)
    ...
    output_array_type = getfield(SindbadCore, toUpperCaseFirst(info.settings.experiment.model_output.output_array_type, "Output"))()
    ...
    run_info = setTupleField(run_info, (:parallelization, getfield(SindbadCore, Symbol(parallelization*"Parallelization"))()))
    land_output_type = getfield(SindbadCore, toUpperCaseFirst(info.settings.experiment.exe_rules.land_output_type, "PreAlloc"))()
