...
function createForcingNamedTuple(incubes, f_sizes, f_dimensions, info)
    ...
    input_array_type = getfield(SindbadCore, toUpperCaseFirst(info.helpers.run.input_array_type, "Input"))()
...
function getForcing(info::NamedTuple)
    ...
    data_backend = getfield(SindbadCore, toUpperCaseFirst(info.helpers.run.input_data_backend, "Backend"))()
