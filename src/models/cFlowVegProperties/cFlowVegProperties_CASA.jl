export cFlowVegProperties_CASA, cFlowVegProperties_CASA_h
"""
...
function precompute(o::cFlowVegProperties_CASA, forcing, land, infotem)
	...
	## pack variables
	@pack_land begin
		p_F ∋ land.cFlowVegProperties
	end
	return land
end

function compute(o::cFlowVegProperties_CASA, forcing, land, infotem)
	@unpack_cFlowVegProperties_CASA o
	...
	#p_fVeg = zeros(size(infotem.pools.carbon.initValues.cEco))
	p_E = p_F
	...
	for ii in 1:size(aM, 1)
		...
		ndxTrg = infotem.pools.carbon.zix.(aM(ii, 2)); #sujan is this 2 | 1?
...
function update(o::cFlowVegProperties_CASA, forcing, land, infotem)
	# @unpack_cFlowVegProperties_CASA o
	return land
end
...
# update
update pools and states in cFlowVegProperties_CASA
...
*Created by:*
 - ncarvalhais
"""
function cFlowVegProperties_CASA_h end