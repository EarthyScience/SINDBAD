export gppAirT_CASA, gppAirT_CASA_h
"""
...
function precompute(o::gppAirT_CASA, forcing, land, infotem)
...
function update(o::gppAirT_CASA, forcing, land, infotem)
	# @unpack_gppAirT_CASA o
	return land
end
...
# precompute:
precompute/instantiate time-invariant variables for gppAirT_CASA
...
# update
update pools and states in gppAirT_CASA
 -
