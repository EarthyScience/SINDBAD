export WUE_Medlyn2011, WUE_Medlyn2011_h
"""
...
function precompute(o::WUE_Medlyn2011, forcing, land, infotem)
...
function compute(o::WUE_Medlyn2011, forcing, land, infotem)
	...
	## unpack variables
	@unpack_land begin
		(PsurfDay, VPDDay) ∈ forcing
		ambCO2 ∈ land.states
	end
	VPDDay[VPDDay < 5E-2] = 5E-2
	...
	## pack variables
	@pack_land begin
		(AoE, AoENoCO2, ci, ciNoCO2) ∋ land.WUE
	end
	return land
end

function update(o::WUE_Medlyn2011, forcing, land, infotem)
	# @unpack_WUE_Medlyn2011 o
	return land
end
...
# precompute:
precompute/instantiate time-invariant variables for WUE_Medlyn2011
...
# update
update pools and states in WUE_Medlyn2011
 - None
