export runoffSurface_directIndirectFroSoil, runoffSurface_directIndirectFroSoil_h
"""
...
function precompute(o::runoffSurface_directIndirectFroSoil, forcing, land, infotem)
	# @unpack_runoffSurface_directIndirectFroSoil o
	return land
end

function compute(o::runoffSurface_directIndirectFroSoil, forcing, land, infotem)
	@unpack_runoffSurface_directIndirectFroSoil o
...
function update(o::runoffSurface_directIndirectFroSoil, forcing, land, infotem)
	@unpack_runoffSurface_directIndirectFroSoil o
...
# precompute:
precompute/instantiate time-invariant variables for runoffSurface_directIndirectFroSoil
...
"""
function runoffSurface_directIndirectFroSoil_h end