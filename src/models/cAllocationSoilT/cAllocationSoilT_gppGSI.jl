export cAllocationSoilT_gppGSI, cAllocationSoilT_gppGSI_h
"""
...
function precompute(o::cAllocationSoilT_gppGSI, forcing, land, infotem)
...
function update(o::cAllocationSoilT_gppGSI, forcing, land, infotem)
	# @unpack_cAllocationSoilT_gppGSI o
	return land
end
...
# precompute:
precompute/instantiate time-invariant variables for cAllocationSoilT_gppGSI
...
# update
update pools and states in cAllocationSoilT_gppGSI
 -
...
"""
function cAllocationSoilT_gppGSI_h end