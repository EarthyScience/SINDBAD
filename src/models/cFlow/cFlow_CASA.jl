export cFlow_CASA, cFlow_CASA_h
"""
...
$(PARAMFIELDS)
"""
@bounds @describe @units @with_kw struct cFlow_CASA{T} <: cFlow
	noParameter::T = nothing | nothing | nothing | nothing
end

function precompute(o::cFlow_CASA, forcing, land, infotem)
	# @unpack_cFlow_CASA o
	return land
end
...
function update(o::cFlow_CASA, forcing, land, infotem)
	# @unpack_cFlow_CASA o
	return land
end
...
# precompute:
precompute/instantiate time-invariant variables for cFlow_CASA
...
# update
update pools and states in cFlow_CASA
 - land.cFlow.p_A
 - land.cFlow.p_E
 - land.cFlow.p_F
