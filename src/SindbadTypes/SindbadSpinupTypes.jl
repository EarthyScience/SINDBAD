...
export SindbadSpinupType
abstract type SindbadSpinupType <: SindbadType end
purpose(::Type{SindbadSpinupType}) = "Abstract type for model spinup related functions and methods in SINDBAD"

# ------------------------- spinup mode ------------------------------------------------------------
export SindbadSpinupMode
...
struct NlsolveFixedpointTrustregionTWS <: SindbadSpinupMode end
...
struct Spinup_cEco_TWS{M,F,T,I,O,N,TWS} <: SindbadSpinupMode
    models::M
    forcing::F
    tem_info::T
    land::I
...
struct Spinup_cEco{M,F,T,I,O,N} <: SindbadSpinupMode
    models::M
    forcing::F
    tem_info::T
    land::I
...
struct SpinupSequenceWithAggregator <: SindbadSpinupType
    forcing::Symbol
    n_repeat::Int
    n_timesteps::Int
    spinup_mode::SindbadSpinupMode
    options::NamedTuple
...
struct SpinupSequence <: SindbadSpinupType
    forcing::Symbol
    n_repeat::Int
    n_timesteps::Int
    spinup_mode::SindbadSpinupMode
