...
function compute(o::groundWsurfaceWInteraction_fracWgw, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
	## unpack parameters
...
function update(o::groundWsurfaceWInteraction_fracWgw, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
	## unpack variables
	@unpack_land begin
		(groundW, surfaceW) ∈ land.pools
