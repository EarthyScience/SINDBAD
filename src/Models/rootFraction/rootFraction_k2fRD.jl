...
@bounds @describe @units @with_kw struct rootFraction_k2fRD{T1, T2} <: rootFraction
	k2_scale::T1 = 0.02f0 | (0.001f0, 0.2f0) | "scales vegFrac to define fraction of 2nd soil layer available for transpiration" | ""
	k1_scale::T2 = 0.5f0 | (0.01f0, 0.99f0) | "scales vegFrac to fraction of 1st soil layer available for transpiration" | ""
end
