...
function precompute(o::totalTWS_sumCombined, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
    @unpack_land begin
...
function compute(o::totalTWS_sumCombined, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
