...
function compute(o::rainSnow_forcing, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
...
function update(o::rainSnow_forcing, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
    ## unpack variables
    @unpack_land begin
        snowW ∈ land.pools
        ΔsnowW ∈ land.states
