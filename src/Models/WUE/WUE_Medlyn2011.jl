...
@bounds @describe @units @with_kw struct WUE_Medlyn2011{T1, T2} <: WUE
	g1::T1 = 3.0f0 | (0.5f0, 12.0f0) | "stomatal conductance parameter" | "kPa^0.5"
	ζ::T2 = 1.0f0 | (0.85f0, 3.5f0) | "sensitivity of WUE to ambient co2" | ""
end
...
function compute(o::WUE_Medlyn2011, forcing, land::NamedTuple, helpers::NamedTuple)
	...
	AoENoCO2 = umol_to_gC * PsurfDay / (1.6f0 * (VPDDay + g1 * sqrt(VPDDay))); # eqn 14 #? gC/mol of H2o?
