...
function compute(o::snowMelt_Tair, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
...
function update(o::snowMelt_Tair, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
    @unpack_snowMelt_Tair o
