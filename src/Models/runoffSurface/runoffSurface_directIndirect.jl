...
@bounds @describe @units @with_kw struct runoffSurface_directIndirect{T1, T2} <: runoffSurface
	dc::T1 = 0.01f0 | (0.0001f0, 1.0f0) | "delayed surface runoff coefficient" | ""
	rf::T2 = 0.5f0 | (0.0001f0, 1.0f0) | "fraction of overland runoff that recharges the surface water storage" | ""
end
