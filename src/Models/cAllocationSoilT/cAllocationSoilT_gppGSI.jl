...
function precompute(o::cAllocationSoilT_gppGSI, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
    ## unpack parameters
...
function compute(o::cAllocationSoilT_gppGSI, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
    ## unpack parameters
    @unpack_cAllocationSoilT_gppGSI o
