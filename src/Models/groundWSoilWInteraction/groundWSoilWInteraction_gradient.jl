...
function compute(o::groundWSoilWInteraction_gradient, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
	## unpack parameters
...
function update(o::groundWSoilWInteraction_gradient, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
	## unpack variables
	@unpack_land begin
