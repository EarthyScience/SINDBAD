...
function precompute(o::gppAirT_GSI, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
	## unpack parameters
...
function compute(o::gppAirT_GSI, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
