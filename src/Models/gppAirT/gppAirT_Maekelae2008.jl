...
function precompute(o::gppAirT_Maekelae2008, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
...
function compute(o::gppAirT_Maekelae2008, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
    ## unpack parameters and forcing
