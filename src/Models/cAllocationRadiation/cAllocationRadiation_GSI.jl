...
function precompute(o::cAllocationRadiation_GSI, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
    ## unpack helper
...
function compute(o::cAllocationRadiation_GSI, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
