...
function compute(o::evaporation_vegFraction, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
	## unpack parameters
...
function update(o::evaporation_vegFraction, forcing::NamedTuple, land::NamedTuple, helpers::NamedTuple)
