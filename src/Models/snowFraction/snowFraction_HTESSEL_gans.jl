export snowFraction_HTESSEL_gans

@bounds @describe @units @with_kw struct snowFraction_HTESSEL_gans{T1} <: snowFraction
	CoverParam::T1 = 15.0 | (1.0, 100.0) | "Snow Cover Parameter" | "mm"
end

function precompute(o::snowFraction_HTESSEL_gans, forcing, land, helpers)
...
function compute(o::snowFraction_HTESSEL_gans, forcing, land, helpers)
	## unpack parameters
	@unpack_snowFraction_HTESSEL_gans o
...
# compute:
Calculate snow cover fraction using snowFraction_HTESSEL_gans
