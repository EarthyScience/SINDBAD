...
function define(p_struct::autoRespiration_Thornley2000B, forcing, land, helpers)
    @unpack_land begin
        cEco ∈ land.pools
    end
...
function compute(p_struct::autoRespiration_Thornley2000B, forcing, land, helpers)
    ## unpack parameters
    @unpack_autoRespiration_Thornley2000B p_struct
    ...
    for ix ∈ zix
        ...
        k_respiration_maintain_ix = min1(o_one / C_to_N_cVeg[ix] * RMN * auto_respiration_f_airT)
