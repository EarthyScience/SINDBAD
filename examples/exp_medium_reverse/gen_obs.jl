...
function out_synt()
    ...
    c = Cube("../data/fluxnet_cube/fluxnet_covariates.zarr")#joinpath(@__DIR__, "/Net/Groups/BGI/work_1/scratch/lalonso/fluxnet_covariates.zarr")) # ../data/fluxnet_cube/fluxnet_covariates.zarr
