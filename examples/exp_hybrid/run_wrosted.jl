...
grads_args = (; tblParams, sites_f, land_init_space, output, forc, obs_synt, forward, tem_helpers, tem_spinup, tem_models, tem_variables, tem_optim, out_variables, f_one);
