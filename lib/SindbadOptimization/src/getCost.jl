...
"""
    cost(param_vector::AbstractArray, base_models, forcing, loc_forcing_t, land_timeseries, land_init, tem_info, observations, tbl_params, cost_options, multi_constraint_method)
...
function cost(param_vector::AbstractArray, base_models, forcing, spinup_forcing, loc_forcing_t, land_timeseries, land_init, tem_info, observations, param_updater, cost_options, multi_constraint_method)
    ...
    cost = combineMetric(cost_vector, multi_constraint_method)
    @debug cost_vector, cost
    return cost
end


"""
    cost(param_vector::AbstractArray, base_models, forcing, loc_forcing_t, land_init, tem_info, observations, tbl_params, cost_options, multi_constraint_method)
...
- `multi_constraint_method`: a method determining how the vector of costes should/not be combined to produce the cost number or vector as required by the selected optimization algorithm
"""
function cost(param_vector::AbstractArray, base_models, forcing, spinup_forcing, loc_forcing_t, land_init, tem_info, observations, param_updater, cost_options, multi_constraint_method)
    updated_models = updateModelParameters(param_updater, base_models, param_vector)
...
function cost(param_vector, selected_models, space_forcing, space_spinup_forcing, loc_forcing_t, output_array, space_output, space_land, tem_info, observations, param_updater, cost_options, multi_constraint_method)
