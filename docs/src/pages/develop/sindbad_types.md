...
This file should not be edited manually; it's automatically generated by when `SetupSimulation` is precompiled, and changes are tracked when a new type is defined.
