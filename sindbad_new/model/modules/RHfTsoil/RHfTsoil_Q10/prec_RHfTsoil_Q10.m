function [f,fe,fx,s,d,p] = prec_RHfTsoil_Q10(f,fe,fx,s,d,p,info)
% #########################################################################
% FUNCTION	: 
% 
% PURPOSE	: 
...
%     TsM     = iniQ10 .^ ((p.RHfTsoil.Tref - TrefPap) ./ 10);
% else
    TsM     = 1;
% end
...
fe.RHfTsoil.fT	= p.RHfTsoil.Q10 .^ ((f.Tair - p.RHfTsoil.Tref) ./ 10) .* TsM; 
