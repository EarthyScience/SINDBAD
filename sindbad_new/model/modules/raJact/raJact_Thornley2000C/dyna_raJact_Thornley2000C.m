function [fx,s,d] = dyna_raJact_Thornley2000C(f,fe,fx,s,d,p,info,tix)
% #########################################################################
% FUNCTION	: dyna_raJact_Thornley2000C
% 
...
for ii = 1:4
    ...
    fx.cEfflux(ii).maintenance(:,tix)	= fe.raJact.km(ii).value(:,tix) .* (1 - p.raJact.YG) .* s.cPools(ii).value;
