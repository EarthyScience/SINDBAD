function [fx,s,d] = raJact_Thornley2000C(f,fe,fx,s,d,p,info,i)
% #########################################################################
% FUNCTION	: raJact_Thornley2000C
% 
...
for ii = 1:4
    ...
    fx.cEfflux(ii).maintenance(:,i)	= fe.AutoResp.km(ii).value(:,i) .* (1 - p.AutoResp.YG) .* s.cPools(ii).value;
