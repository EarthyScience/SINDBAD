function [cost, costComps] = calcCostBaseline(f,fe,fx,s,d,p,obs,info)
% baseline cost function using robust metrics and data uncertainty
...
% [cost]    = calcCostBaseline([],[],fx,[],d,[],obs,info)
...
% SWE threshold
SWEobs(SWEobs>100)  =   100;
SWEmod(SWEmod>100)  =   100;
