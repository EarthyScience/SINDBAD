function [cost, costComps] = calcCostBaseline_Area_Qsq(f,fe,fx,s,d,p,obs,info)
...
q_resid     =   sum( (Q_MSCobs(vQ)-Q_MSCmod(vQ)).^2 );
q_var       =   sum( (Q_MSCobs(vQ)-mean(Q_MSCobs(vQ))).^2 );
