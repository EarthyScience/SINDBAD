function [cost, costComps] = calcCostBaseline_Area2(f,fe,fx,s,d,p,obs,info)
% baseline cost function using robust metrics, data uncertainty and area
% weights
% tVec      = vector with month (M)
% cost      = costTWS + costSWE + costSM + 2*costET + costQ
...
%% total costs
costTotal   =   costTWS + costSWE + costSM + 2*costET + costQ;
