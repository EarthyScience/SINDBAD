function [Alpha,Beta,K,Theta,Psi] = calcSoilParams(p,fe,info,WT)
% #########################################################################
...
CLAY    = p.pSoil.CLAY .* 100 .* info.tem.helpers.arrays.onespix;
SAND    = p.pSoil.SAND .* 100 .* info.tem.helpers.arrays.onespix;
