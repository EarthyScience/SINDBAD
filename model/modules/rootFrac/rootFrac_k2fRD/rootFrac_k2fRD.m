function [f,fe,fx,s,d,p]=rootFrac_k2fRD(f,fe,fx,s,d,p,info)
% +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
% sets the maximum fraction of water that root can uptake from soil layers
% as function of vegetation fraction, and for the second soil layer additional as function of RD
%
% Inputs:
...
%   - p.rootFrac.k2_scale   : vegFrac scalar for k2 
%   - p.rootFrac.k2_RDscale : RD scalar for k2
%
% Outputs:
...
k1RootFrac                    =   s.cd.vegFrac .* p.rootFrac.k1_scale; % the fraction of water that a root can uptake from the 1st soil layer
k2RootFrac                    =   s.cd.vegFrac .* p.rootFrac.k2_scale; % the fraction of water that a root can uptake from the 1st soil layer
