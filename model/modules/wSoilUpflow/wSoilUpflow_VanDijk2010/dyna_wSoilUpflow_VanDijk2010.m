...
for sl=wSoilend:-1:2
    ...
    k_unsat_lower                 =   feval(p.pSoil.kUnsatFuncH,p,info,dosSoilLower,kSat_lower,Beta_lower);    
    ...
    k_unsat_upper                 =   feval(p.pSoil.kUnsatFuncH,p,info,dosSoilUpper,kSat_upper,Beta_upper);    
