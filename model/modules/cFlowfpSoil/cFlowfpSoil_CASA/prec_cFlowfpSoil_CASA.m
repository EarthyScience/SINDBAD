...
aME	= {...
    'cMicSoil',     'cSoilSlow',    p.cFlowfpSoil.effA - (p.cFlowfpSoil.effB .* (p.soilTexture.SILT + p.soilTexture.CLAY));...
    'cMicSoil',     'cSoilOld',     p.cFlowfpSoil.effA - (p.cFlowfpSoil.effB .* (p.soilTexture.SILT + p.soilTexture.CLAY));...
	};
	
aMF = {...
    'cSoilSlow',    'cMicSoil',     1 - (p.cFlowfpSoil.effCLAY_cSoilSlow_A + (p.cFlowfpSoil.effCLAY_cSoilSlow_B .* p.soilTexture.CLAY));...
    'cSoilSlow',    'cSoilOld',     p.cFlowfpSoil.effCLAY_cSoilSlow_A + (p.cFlowfpSoil.effCLAY_cSoilSlow_B .* p.soilTexture.CLAY);...
    'cMicSoil',     'cSoilSlow',    1 - (p.cFlowfpSoil.effCLAY_cMicSoil_A + (p.cFlowfpSoil.effCLAY_cMicSoil_B .* p.soilTexture.CLAY));...
    'cMicSoil',     'cSoilOld',     p.cFlowfpSoil.effCLAY_cMicSoil_A + (p.cFlowfpSoil.effCLAY_cMicSoil_B .* p.soilTexture.CLAY);...
    };
