...
VMC                             = min(max((sum(s.w.wSoil .* fe.wSoilBase.fracRoot2SoilD,2) - sum(fe.wSoilBase.wWP .* fe.wSoilBase.fracRoot2SoilD,2)),0) ./ sum(fe.wSoilBase.wAWC .* fe.wSoilBase.fracRoot2SoilD,2),1);
