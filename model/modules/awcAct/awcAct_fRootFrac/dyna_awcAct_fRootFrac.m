function [f,fe,fx,s,d,p]=dyna_awcAct_fRootFrac(f,fe,fx,s,d,p,info,tix)
% +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
for sl = 1:nSoilLayers
    wSoilAvail                      =   minsb(s.w.wSoil(:,sl),s.wd.p_wSoilBase_wFC(:,sl));
    s.wd.awcAct(:,sl)               =   s.wd.p_rootFrac_fracRoot2SoilD(:,sl) .* (maxsb(wSoilAvail - s.wd.p_wSoilBase_wWP(:,sl),0));
end
end