function [fe,fx,d,p] = Prec_Sublimation_GLEAM(f,fe,fx,s,d,p,info)
% #########################################################################
...
fe.Sublimation.PTtermSub = repmat( p.Sublimation.alpha ,1,info.forcing.size(2)) .*(Delta./(Delta+Gamma))./Lambda;
